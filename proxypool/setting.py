...
# definition of flags
IS_WINDOWS = platform.system().lower() == 'Darwin'
...
REDIS_HOST = env.str('PROXYPOOL_REDIS_HOST',
                     env.str('REDIS_HOST', '192.168.50.49'))
# redis port
...
# redis connection string, like redis://[password]@host:port or redis://[password]@host:port/0,
